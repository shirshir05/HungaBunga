...
neighbor_leaf_size = [1, 2, 5, 10, 20, 30, 50, 100, 1000]
neighbor_metric = ['euclidean', 'l2', 'minkowski', 'p', 'manhattan', 'cityblock', 'l1', 'chebyshev', 'infinity', 'seuclidean', 'mahalanobis', 'wminkowski', 'hamming', 'canberra', 'braycurtis', 'matching', 'jaccard', 'dice', 'kulsinski', 'rogerstanimoto', 'russellrao', 'sokalmichener', 'sokalsneath', 'haversine', 'pyfunc']
...
max_depth_small = [None, 5, 10, 50]
min_samples_split = [0.1, 500, 50]
